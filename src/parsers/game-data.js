...
const PROFESSION_DETAILS = {
  'Unemployed': { 'perk': '25% more experience gained', 'description': 'Having no real skills or the motivation to hold down a job, you start your fight for survival with no useful skills or perks to aide you along the way.', 'affliction': 'No Affliction', 'unlockedSkills': [] },
  'Amateur Boxer': { 'perk': 'Fist fighting deals 300% unarmed damage', 'description': 'Years of boxing have hardened your fists and your spirit.', 'affliction': 'Random Affliction', 'unlockedSkills': ['WRESTLER', 'SPRINTER'] },
  'Farmer': { 'perk': 'Fertilizer is more potent', 'description': 'Working the land has taught you patience and resourcefulness.', 'affliction': 'Random Affliction', 'unlockedSkills': ['BANDOLEER', 'CARPENTRY'] },
  'Mechanic': { 'perk': '50% more effective with Repair Kits', 'description': 'Years of fixing cars and machinery has made you handy with tools.', 'affliction': 'Random Affliction', 'unlockedSkills': ['METAL WORKING', 'CALLUSED'] },
  'Car Salesman': { 'perk': '25% less NPC trading cost', 'description': 'Smooth talking comes naturally and people trust you.', 'affliction': 'Random Affliction', 'unlockedSkills': ['CHARISMA', 'HAGGLER'] },
  'Outdoorsman': { 'perk': '10% less bow sway', 'description': 'Living off the land is second nature to you.', 'affliction': 'Random Affliction', 'unlockedSkills': ['VITAL SHOT', 'SPEED STEALTH'] },
  'Chemist': { 'perk': 'Craft x2 treatments at chemistry station', 'description': 'A background in chemistry gives you an edge in crafting medicines.', 'affliction': 'Random Affliction', 'unlockedSkills': ['INFECTION TREATMENT', 'HEALTHY GUT'] },
  'Emergency Medical Technician': { 'perk': '25% better healing effectiveness', 'description': 'First responder training has prepared you for trauma situations.', 'affliction': 'Random Affliction', 'unlockedSkills': ['CALLUSED', 'REDEYE'] },
  'Military Veteran': { 'perk': '2x fatigue resistance', 'description': 'Military training has hardened your body and mind.', 'affliction': 'Random Affliction', 'unlockedSkills': ['RELOADER', 'MAG FLIP'] },
  'Thief': { 'perk': 'No alarms triggered when stealing', 'description': 'A life of crime has taught you how to move silently.', 'affliction': 'Random Affliction', 'unlockedSkills': ['DEEP POCKETS', 'LIGHTFOOT'] },
  'Fire Fighter': { 'perk': 'No overheat from fire/heat', 'description': 'Braving fires has made you resistant to heat.', 'affliction': 'Random Affliction', 'unlockedSkills': ['BEAST OF BURDEN', 'CONTROLLED BREATHING'] },
  'Electrical Engineer': { 'perk': 'Unlock all powered structures', 'description': 'Your knowledge of electronics lets you build advanced machinery.', 'affliction': 'Random Affliction', 'unlockedSkills': ['HACKER', 'RING MY BELL'] },
};
