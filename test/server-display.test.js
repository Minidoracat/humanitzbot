 ...
 *
 * Covers: settingBool, settingLabel, settingMultiplier, settingDays,
 *         settingPermaDeath, spawnLabel, ON_DEATH_LABELS, AI_EVENT_LABELS,
 *         formatTime, difficultyLabel, buildSettingsFields, buildLootScarcity,
 *         progressBar, blockBar, weatherEmoji, seasonEmoji, timeEmoji.
 *
 * Also covers: modalTitle (from discord-utils.js).
 *
 * Run: npm test
 */
...
// ═══════════════════════════════════════════════════════════════════════════
//  settingMultiplier (V35 float multiplier)
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
//  settingDays (V35 day/duration display)
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
//  settingPermaDeath (V35 boolean + legacy enum)
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
//  spawnLabel (V35 float multiplier)
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
//  buildLootScarcity (with legacy LootRarity fallback)
// ═══════════════════════════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════════════════════════
//  modalTitle (discord-utils.js — Bug #3 GitHub issue)
// ═══════════════════════════════════════════════════════════════════════════
...
describe('modalTitle', () => {
  ...
  it('handles emoji/surrogate pairs without splitting', () => {
    // Emoji like 🔄 are 2 code units but 1 character — Array.from handles this
    const prefix = 'A: ';
    const suffix = '';
    const maxName = 45 - 3;
    const name = '🔄'.repeat(maxName); // plenty of emoji
    const result = modalTitle(prefix, name, suffix);
    // modalTitle counts by Array.from (characters), not .length (code units)
