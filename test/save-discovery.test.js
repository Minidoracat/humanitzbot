 ...
 * Verifies that the bot can discover save files regardless of the
 * SaveName configured in GameServerSettings.ini.
 *
 * Run: npm test
 */
...
// ══════════════════════════════════════════════════════════
// SAVE_FILE_PATTERN — matches Save_*.sav, excludes ClanData
// ══════════════════════════════════════════════════════════
...
// ══════════════════════════════════════════════════════════
// _extractSaveName — parses SaveName from GameServerSettings.ini
// ══════════════════════════════════════════════════════════
